import { PROJECT_CONFIG, type ProjectKey } from "./ProjectConfig";
...
function Project({ projectName, onProjectSelect }: ProjectProps) {
...
export default function ProjectList({ onProjectSelect }: ProjectListProps) {
  const repos = Object.keys(PROJECT_CONFIG) as ProjectKey[];
  return (
